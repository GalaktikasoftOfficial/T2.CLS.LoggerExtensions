...
{
	[Target("DurableFluentd")]
	public class DurableFluentdTarget : TargetWithLayout
	{
		#region Properties
		...
		[DefaultParameter]
		public int FileBufferLimit { get; set; } = 1024;

		[DefaultParameter]
		public int FluentBufferLimit { get; set; } = 512;
		...
		private DurableFluentdHttpSender Transport { get; set; }
		...
		protected virtual DurableFluentdHttpSender CreateTransport()
		{
			return new DurableFluentdHttpSender(RequestUri.ToArray(), HttpClient, BufferPath, MemoryBufferLimit, FileBufferLimit, FluentBufferLimit, FlushTimeout, WorkerCount, Encoding, InternalLoggerFactory.Instance);
		}
